...
```bash
git clone https://github.com/amirsohail100/Rainfall-Prediction-Dashboard-using-Machine-Learning.git
cd Rainfall-Prediction-Dashboard-using-Machine-Learning
```
